...
public class DoorListAdapter extends BaseAdapter {
    ...
    private ArrayList<DoorListBean> mData;

    private Context mContext;
    private LayoutInflater inflater = null;

    DoorListAdapter(ArrayList<DoorListBean> mData, Context context) {
        mContext = context;
    ...
    @Override
    public DoorListBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(
                    R.layout.door_list_item, null);
            holder = new ViewHolder();

            holder.tvDoorName = (TextView) convertView.findViewById(R.id.tvDoorName);
        ...
        final DoorListBean tempBean = mData.get(position);
        holder.tvDoorName.setText(tempBean.getDoorName());
        ...
        holder.tvTime.setText(tempBean.getLastUpdate());
    ...
    static class ViewHolder {
        private TextView tvDoorName, tvDoorStatus, tvTime;
    }
}
